...
LOG_CHANNEL_ID = [1477923902834475080,1362413073436250354]
ADMIN_CONTROL_CHANNEL = [1477954227442679910, 1362413073436250354]
...
class ChannelSel(discord.ui.View):
    def __init__(self, content, attachments):
        ...
        priority_names = ["staff-talk", "tickets-🎫-✓", "general-chat-💬", "rulebook-📜", "announcements", "rulebook-for-sutffs-📑", "polls", "media-saver-🎞️", "🎼-music-vc-guide", "store"]
        options = []
